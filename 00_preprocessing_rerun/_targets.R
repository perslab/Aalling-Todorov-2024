...
# source("../00_preprocessing/gprofiler_requests.R")
...
list(    
  tar_target(exp22_path, paste0(PROJECT_DIR, 'data/received/SCOP_2022_0189__202301217/Output/data/aggregated-filtered/220706-B_hypothalamus/220706-B_hypothalamus_rna-seurat.rds'), format = "file"),
  tar_target(exp23_path, paste0(PROJECT_DIR, 'data/received/SCOP_2022_0189__202301217/Output/data/aggregated-filtered/220706-A_hypothalamus/220706-A_hypothalamus_rna-seurat.rds'), format = "file"),
  tar_target(exp24_path, paste0(PROJECT_DIR, 'data/received/SCOP_2022_0189__202301217/Output/data/aggregated-filtered/220705_hypothalamus/220705_hypothalamus_rna-seurat.rds'), format = "file"),
